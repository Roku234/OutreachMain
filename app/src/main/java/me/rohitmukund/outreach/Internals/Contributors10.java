...
public class Contributors10 extends AppCompatActivity
{
    ArrayList<String> repositorie;
    Information info = new Information();
    final String url = "https://api.github.com/repos/JBossOutreach/certificate-generator-front/contributors";
