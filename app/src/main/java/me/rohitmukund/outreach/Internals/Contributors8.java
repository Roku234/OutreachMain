...
public class Contributors8 extends AppCompatActivity
{
    ArrayList<String> repositorie;
    Information info = new Information();
    final String url = "https://api.github.com/repos/JBossOutreach/certificate-generator-server/contributors";
